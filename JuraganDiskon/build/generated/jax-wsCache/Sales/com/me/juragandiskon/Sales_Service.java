 ...
 * 
 */
@WebServiceClient(name = "Sales", targetNamespace = "http://juragandiskon.me.com/", wsdlLocation = "http://localhost:8081/MarketplaceWebService/Sales?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SALES_QNAME = new QName("http://juragandiskon.me.com/", "Sales");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/MarketplaceWebService/Sales?wsdl");
    ...
    public Sales getSalesPort() {
        return super.getPort(new QName("http://juragandiskon.me.com/", "SalesPort"), Sales.class);
    }
    ...
    public Sales getSalesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://juragandiskon.me.com/", "SalesPort"), Sales.class, features);
    }
