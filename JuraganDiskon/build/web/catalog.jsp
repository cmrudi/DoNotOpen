            ...
            <div>
                ...
                <div class="right-container">
                    ...
                    <p><% out.println(catalog[i][6]); %> purchases<br></p>
                      <a type="button" class="<% if (catalog[i][9].equals("1")) { out.print("likedButton");} else { out.print("likeButton");} %>" id="likeButton" href="/JuraganDiskon/like.jsp?prod_id=<% out.println(catalog[i][0]); %>">Like</a>
                      <a type="button" id="buyButton" href="/JuraganDiskon/confirmationPurchase.jsp?prod_id=<% out.println(catalog[i][0]); %>">Buy</a>
                </div>
            </div>
            <br>
            <hr>
