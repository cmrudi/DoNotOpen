...
%>
    ...
    <%
    try {
	com.me.juragandiskon.Sales_Service service = new com.me.juragandiskon.Sales_Service();
	com.me.juragandiskon.Sales port = service.getSalesPort();
	...
	out.println("Result = "+result);
        ...
        for (j = 0; j< productNum; j++) {
            ...
            i++;
            products[j][6] = result.get(i); //username
            i++;
...
*/              out.println(products[i][0]);
            ...
            <div>
                ...
                <div class="mid-container">
                    ...
                    <% out.println("bought by <b>" + products[i][6] + "</b>"); %><br></p>
                ...
                <div class="right-container">
                    ...
                    <% out.println(products[i][10]); %><br><br><br></p><br><br>
                </div>
            </div>
            <br>
            <hr>
